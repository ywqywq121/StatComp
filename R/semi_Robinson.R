#' @title Semiparametric partially linear model with Robinson method
#' @description Use R to do  Semiparametric partially linear model with Robinson method
